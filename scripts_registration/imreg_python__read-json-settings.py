...
def main():
    ...
    for no_of_datacube in range(amount_of_datacubes):
        ...
        config_for_datacube = {
            ...
            #'folder_partial_results': 'results_datacube_' + str(no_of_datacube) #destination_folder
        }

        datacube = {**config_for_datacube, **datacube_from_json}    #230210

        #fixed_image_as_array_from_json_dict = get_fixed_image_as_array_from_json(data_from_json)   #231218
        fixed_image_as_array_from_json_dict = get_fixed_image_as_array_from_json_COLOR(data_from_json)

        #print(fixed_image_as_array_from_json_dict)
        ...
        # plt.imsave('results/' + config['datacube_no'] + 'fixed_image_from_json__scale_' + str(fixed_image_as_array_from_json_dict['scaling']) + '.png', fixed_image_scaled)
        #
        ...
        # plt.imsave('results/' + config['datacube_no'] + 'fixed_image_from_json__scale_' + str(fixed_image_as_array_from_json_dict['scaling']) + '_COLOR.png', fixed_image_scaled_COLOR)
        #
        # #/////////////
        ...
        # 01.save full size fixed image GREYSCALE (scaled following json settings)
        fixed_image_scaled = image_scale(fixed_image_as_array_from_json_dict['fixed_image_as_array'], fixed_image_as_array_from_json_dict['scaling'])
        plt.imsave(destination_folder + '/results/' + config['datacube_no'] + 'fixed_image_from_json__scale_' + str(fixed_image_as_array_from_json_dict['scaling']) + '.png', fixed_image_scaled)
        #plt.imsave('results/' + config['datacube_no'] + 'fixed_image_from_json__scale_' + str(fixed_image_as_array_from_json_dict['scaling']) + '.png', fixed_image_scaled)


        # 01 b.save full size fixed image COLOR (scaled following json settings)
        fixed_image_scaled_COLOR = image_scale(fixed_image_as_array_from_json_dict['fixed_image_as_array_COLOR'], fixed_image_as_array_from_json_dict['scaling'])
        plt.imsave(destination_folder + '/results/' + config['datacube_no'] + 'fixed_image_from_json__scale_' + str(fixed_image_as_array_from_json_dict['scaling']) + '_COLOR.png', fixed_image_scaled_COLOR) #231218
        #plt.imsave('results/' + config['datacube_no'] + 'fixed_image_from_json__scale_' + str(fixed_image_as_array_from_json_dict['scaling']) + '_COLOR.png', fixed_image_scaled_COLOR) #231218
        ...
        #print('datacube_from_json_by_id = ' + str(datacube_from_json_by_id))
        ...
        #the difference is that I enter with fixed_img as array, and moving images as array too
        ...
        for key, image in png_images.items():
            plt.imsave(destination_folder + '/results/' + config['datacube_no'] + 'Final_transformed_image_' + key + '.png', image) # plt.imsave(config['datacube_no'] + 'Final_transformed_image_' + key + '.png', image)
            #destination_folder + '/results/'
            #plt.imsave('results/' + config['datacube_no'] + 'Final_transformed_image_' + key + '.png', image) # plt.imsave(config['datacube_no'] + 'Final_transformed_image_' + key + '.png', image)
